  ...
  test("Extract Data: no field", async () => {
    ...
    const mockData = [
      ...
      },
      {
        ...
        NetworkIn_Average: 171400566,
        NetworkOut_Average: 163390599,
        MemoryUtilization_Average: 40.33998435,
        Final_Target: 34.3093731
      },
      {
        CPUUtilization_Average: 37,
        NetworkIn_Average: 183125327,
        NetworkOut_Average: 174387148,
  ...
  test("Batching data and select", async () => {
    ...
    const mockData = [
      ...
      },
      {
        ...
        NetworkIn_Average: 209125328,
        NetworkOut_Average: 204387147,
